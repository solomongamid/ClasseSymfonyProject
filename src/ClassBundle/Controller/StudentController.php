...
class StudentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $students = $em->getRepository('ClassBundle:Student')->findAll();
    ...
    {
        $student = new Student();
        $form = $this->createForm('ClassBundle\Form\StudentType', $student);
    ...
    {
        $deleteForm = $this->createDeleteForm($student);
        $editForm = $this->createForm('ClassBundle\Form\StudentType', $student);
